...
class CartService
{
    ...
    protected $produitsRepository; // création d'une variable protégee $produitsRepository

    /**
     * création d'un constructeur qui contient les variables $session et $produitsRepository afin de permettre leurs instanciations
